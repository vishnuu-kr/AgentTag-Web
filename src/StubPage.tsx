...
const COPY: Record<StubSlug, CopyBlock> = {
  'case-studies': {
    ...
    paragraphs: [
      ...
      'If you operate an autonomous-agent deployment and would like to be featured, email hello@agenttag.me with a short description of your agent system and the control you would expect.',
    ],
  },
  blog: {
  ...
  terms: {
    ...
    paragraphs: [
      'These Terms of Service govern your use of the AgentTag.me product and the agenttag.me website operated by AgentTag.me ("we", "us").',
      ...
      'For the complete agreement, contact us at hello@agenttag.me or send postal correspondence to the address listed at the bottom of this page.',
    ],
  },
  privacy: {
    ...
    paragraphs: [
      ...
      'For the full privacy notice, including data-subject rights and contact procedures, email privacy@agenttag.me.',
    ],
  },
  'data-tos': {
    ...
    paragraphs: [
      ...
      'For the complete Data Platform Terms, including security and confidentiality commitments, email dpa@agenttag.me.',
    ],
  },
}
...
export default function StubPage({ slug }: { slug: StubSlug }) {
  ...
  return (
    ...
    >
      ...
      {slug === 'blog' && (
        <div className="aeg-dash" style={{ marginTop: 64, marginBottom: 64, padding: '0 16px' }}>
          <BlogsSection />
        </div>
      )}
      ...
      >
        AgentTag.me · Free public beta · <a href="/#contact" style={{ color: 'inherit' }}>Contact</a>
      </div>
    </main>
  )
}
